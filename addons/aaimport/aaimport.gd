...
func _enter_tree():
  ...
  fli_import_plugin = preload("fli_import_plugin.gd").new()
  ...
  add_import_plugin(fli_import_plugin)
...
func _exit_tree():
  ...
  remove_import_plugin(fli_import_plugin)
